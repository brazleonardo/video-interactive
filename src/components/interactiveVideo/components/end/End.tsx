                ...
                <Component.When is={!!data.quiz}>
                    <Component.Card>
                        <Component.Info>
                            ...
                            <Component.CardText>{data.quiz?.questionsAnswered}/{data.quiz?.total}</Component.CardText>
                        </Component.Info>
                        <Component.WrapIcon>
                ...
                <Component.When is={!!data.comment}>
                    <Component.Card>
                        <Component.Info>
                            ...
                            <Component.CardText>{data.comment?.questionsAnswered}/{data.comment?.total}</Component.CardText>
                        </Component.Info>
                        <Component.WrapIcon>
                ...
                <Component.When is={!!data.check}>
                    <Component.Card>
                        <Component.Info>
                            ...
                            <Component.CardText>{data.check?.questionsAnswered}/{data.check?.total}</Component.CardText>
                        </Component.Info>
                        <Component.WrapIcon>
                            <Component.FaCheck />
                        </Component.WrapIcon>
                ...
                <Component.When is={!!data.info}>
                    <Component.Card>
                        <Component.Info>
                            ...
                            <Component.CardText>{data.info?.questionsAnswered}/{data.info?.total}</Component.CardText>
                        </Component.Info>
                        <Component.WrapIcon>
                            <Component.FaInfo />
                        </Component.WrapIcon>
