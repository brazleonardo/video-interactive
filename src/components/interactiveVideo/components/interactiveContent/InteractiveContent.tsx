...
const InteractiveContent = ({ data }: Props) => {
  const { onChangeResponse, onSubmit, onSubmitComment, onContinue } =
    useInteractiveVideo()
      ...
      return (
        <Component.Content>
          <Component.GroupAnswers>
            <Component.Question>{data.content.question}</Component.Question>
            <Component.Comment
              value={data.content?.questionAnswer ?? ''}
              onChange={(e) => onChangeResponse(e, data.time)}
            ></Component.Comment>
          </Component.GroupAnswers>
          <Component.GroupBtn>
  ...
  return <Component.Container>{renderContent()}</Component.Container>
}
